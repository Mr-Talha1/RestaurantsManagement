...
namespace TBAppBackend.Repositories
{
    public interface ICoreRepository
    {
        ...
        Task<KpiDto> GetKpiDataAsync(long merchantId, DateTime fromDate, DateTime toDate, int? branchId);
        Task<List<ProductStatDto>> GetProductStatsAsync(long merchantId, DateTime fromDate, DateTime toDate, int? branchId);
        Task<TimeDataDto> GetTimeDataAsync(long merchantId, DateTime fromDate, DateTime toDate, int? branchId);
        Task<TaxSummaryDto> GetTaxSummaryAsync(long merchantId, DateTime fromDate, DateTime toDate, int? branchId);
        Task<DiscountSummaryDto> GetDiscountSummaryAsync(long merchantId, DateTime fromDate, DateTime toDate, int? branchId);
        Task<List<PaymentMethodDto>> GetPaymentMethodStatsAsync(long merchantId, DateTime fromDate, DateTime toDate, int? branchId);
        Task<OrderStatsDto> GetOrderStatsAsync(long merchantId, DateTime fromDate, DateTime toDate, int? branchId);
